...
% clf;
plot(y_acceleration, 'LineWidth', LineWidth);
...
y_position_plus_5_percent=100.*y_position_plus_5_percent;
    %% Differentiate y_position twice into y_acceleration
for i=1:length(t)-1
...
y_position_minus_5_percent=100.*y_position_minus_5_percent;
    %% Differentiate y_position twice into y_acceleration
for i=1:length(t)-1
...
y_position_minus_5_percent_PID=100.*y_position_minus_5_percent_PID;
    %% Differentiate y_position twice into y_acceleration
for i=1:length(t)-1
